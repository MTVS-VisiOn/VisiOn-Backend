    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http.cors(cors -> cors.disable())
                ...
                .authorizeHttpRequests(auth ->auth
                        ...
                        .requestMatchers( "/api/users/device/pairing/token").hasAuthority("WARD")
                        ...
                        .requestMatchers("/api/auth/logout").hasAnyAuthority("WARD","GUARDIAN")
                        .requestMatchers(HttpMethod.POST,"/api/presence").hasAnyAuthority("WARD","DEVICE")
                        ...
                        .requestMatchers("/api/locations/search").hasAnyAuthority("WARD", "DEVICE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/ice-servers").hasAnyAuthority("WARD","GUARDIAN","DEVICE")
                        .requestMatchers("/api/alerts/detect/obstacle").hasAnyAuthority("WARD","DEVICE")
